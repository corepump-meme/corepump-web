...
export function TickerTape({ className = '' }: TickerTapeProps) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 top-0 w-16 h-full bg-gradient-to-r from-black/95 to-transparent z-10 pointer-events-none" />
      <div className="absolute right-0 top-0 w-16 h-full bg-gradient-to-l from-black/95 to-transparent z-10 pointer-events-none" />
