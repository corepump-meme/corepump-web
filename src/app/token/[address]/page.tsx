...
export default async function TokenPage({ params }: TokenPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background-secondary to-background-tertiary dark:from-dark-bg-secondary dark:to-dark-bg-tertiary py-8 px-4 sm:px-6 lg:px-8">
